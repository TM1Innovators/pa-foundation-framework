601,100
602,"}Drill_Cube Control to View Source"
562,"NULL"
586,"BLD View Source"
585,"BLD View Source"
564,
565,"s?O2[=xUO]??XX]Ca:maoPd_:f2p5AYO9VBYoTrwXm^NyarXzyd`Vov5NpweYqLj4YTSBspgmh1`<ga`Ga0hId?5GHMyDXCD]q5=9FoY[cBDGV5^UoznPhT53=MdWm[8nS5gtT?bjPUE]TQNBY2UfA?zhTqca0erN^XHt7KU<;Z;Qm?7oWXU<T61=fXW;6sR^r1jsxS@"
559,1
928,1
593,
594,
...
sTarget_Cube_Name = 'BLD View Source';
...
sView_List_Dimension_Name = 'BLD View List';
...
sTarget_View_List_Type = 'S';
sTarget_View_List_Element = 'Default';

## [BLD Cube Dimension List]
## We just want to read items from the 'Default' subset
sTarget_Cube_Dimension_List_Type = 'S';
sTarget_Cube_Dimension_List_Element = 'Leaf Elements';
...
ViewTitleDimensionSet( sTarget_Cube_Name, sTarget_View_Name, sView_List_Dimension_Name );
...
ViewRowSuppressZeroesSet( sTarget_Cube_Name, sTarget_View_Name, 1 );
573,3
