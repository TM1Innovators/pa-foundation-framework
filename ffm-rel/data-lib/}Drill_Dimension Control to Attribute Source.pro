601,100
602,"}Drill_Dimension Control to Attribute Source"
562,"NULL"
586,"BLD Attribute Source"
585,"BLD Attribute Source"
564,
565,"cT7agiIhZbE]8yq1giH5oi`n6V1PB;HWHZE7XkOZjXEO@dsY3oqETzbe3i=2O5u[K;aT?n0Kt8R`Tf85V[WH@XM?8xNdxkdz4p5d:\7MgaNQ^^]wl6srF;kLAM:=TDV5mF@g3>:K6b<bji0;gd25w4pdIaYPxNZE9]pHpQz5OJqyFekbIxPrwSc_V:8[^_upF<cgOn_G"
559,1
928,1
593,
594,
...
sTarget_Cube_Name = 'BLD Attribute Source';
...
sTarget_Attribute_List_Type = 'S';
sTarget_Attribute_List_Element = 'Default';
...
sTarget_Subset_Element_List = ''
	...
	| sTarget_Attribute_List_Element | ','
...
ViewRowDimensionSet( sTarget_Cube_Name, sTarget_View_Name, sAttribute_List_Dimension_Name, 1 );
